...
log "INFO" "Running make for CcspCMAgentDmlTest_gtest.bin..."
if make -C source/test/CcspCMAgentDmlTest; then
...
if [ -f "./source/test/CcspCMAgentDmlTest/CcspCMAgentDmlTest_gtest.bin" ]; then
    log "INFO" "Running CcspCMAgentDmlTest_gtest.bin"
    ./source/test/CcspCMAgentDmlTest/CcspCMAgentDmlTest_gtest.bin
    log "INFO" "Completed Test Execution"
else
    log "ERROR" "CcspCMAgentDmlTest_gtest.bin does not exist, cannot run tests"
    exit 1
fi
